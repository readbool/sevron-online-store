...
final class MarkAsShippedController extends AbstractBaseController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $updatedOrder = $this->orderStatusUpdater->updateStatus($order, OrderStatusEnum::SHIPPED);

        return $this->sendResponse($updatedOrder, 'Order updated.');
    }
}
